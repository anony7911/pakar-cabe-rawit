...
if ($cek > 0) {
	...
	if ($data['tingkat']=="admin") {
		...
		header('location:admin/penyakit.php'); //jika berhasil login, maka masuk ke file yang dituju
	} elseif ($data['tingkat']=="dokter") {
		$_SESSION['username'] = $username;
		$_SESSION['tingkat'] = "dokter";
		//$_SESSION['id_admin'] = $data['id_admin'];
		header('location:dokter/konsultasi.php'); //jika berhasil login, maka masuk ke file yang dituju
	} else {
